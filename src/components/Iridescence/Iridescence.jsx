...
// Kept faithful to the upstream source.
const vertexShader = `
attribute vec2 uv;
...
export default function Iridescence({ color = [1, 1, 1], speed = 1.0, amplitude = 0.1, mouseReact = true, ...rest }) {
  ...
  useEffect(() => {
    ...
    // Render at the device pixel ratio so the shader stays crisp on hi-DPI
    // displays instead of being upscaled from 1x (which looks blurry).
