...
tos.py flash`,
    ...
    realWorldValidation: {
      ...
      body: 'We built a TuyaOpen SDK Expert Skill with deep know-how for real hardware—optimized for VibeCoding. It guides you from new project setup and device authentication through build, flash, debug, and injected event testing, with a hardware-in-the-loop mindset so shipping connected AI device hardware is faster and easier.',
...
tos.py flash`,
    ...
    realWorldValidation: {
      ...
      titleBase: '真实硬件',
      body: '我们推出 TuyaOpen SDK 专家 Skill：沉淀硬件开发最佳实践，面向 VibeCoding 优化——从新建工程、设备认证、编译烧录，到调试与事件注入测试，全程遵循硬件在环思路，让联网 AI 设备硬件落地更快、更省力。',
      consoleTitle: 'VibeCoding agent',
