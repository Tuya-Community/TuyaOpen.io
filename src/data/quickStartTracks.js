  ...
  en: [
    {
      ...
      entry: { label: 'Start with the IDE', href: '/learn/tuyaopen-ide-overview' },
      steps: [
        { href: '/learn/tuyaopen-ide-overview', title: 'What TuyaOpen IDE is' },
        { href: '/learn/tuyaopen-ide-install', title: 'Install the IDE' },
        { href: '/learn/tuyaopen-ide-practice-1', title: 'Practice 1 — Hello World' },
        { href: '/learn/tuyaopen-ide-practice-2', title: 'Practice 2 — your_chat_bot' },
        { href: '/learn/tuyaopen-ide-practice-3', title: 'Practice 3 — mini app panel' },
        { href: '/learn/tuyaopen-ide-practice-4', title: 'Practice 4 — Hello World on Linux' },
        { href: '/learn/tuyaopen-ide-vibe-coding', title: 'Vibe Coding skills' },
        { href: '/learn/tuyaopen-ide-agent-dev', title: 'Agent development guide' },
      ],
    },
    {
      id: 'sdk',
  ...
  zh: [
    {
      ...
      entry: { label: '从 IDE 开始', href: '/learn/tuyaopen-ide-overview' },
      steps: [
        { href: '/learn/tuyaopen-ide-overview', title: 'TuyaOpen IDE 是什么' },
        { href: '/learn/tuyaopen-ide-install', title: '安装 TuyaOpen IDE' },
        { href: '/learn/tuyaopen-ide-practice-1', title: '实战一 —— Hello World' },
        { href: '/learn/tuyaopen-ide-practice-2', title: '实战二 —— your_chat_bot' },
        { href: '/learn/tuyaopen-ide-practice-3', title: '实战三 —— 小程序面板' },
        { href: '/learn/tuyaopen-ide-practice-4', title: '实战四 —— Linux 板 Hello World' },
        { href: '/learn/tuyaopen-ide-vibe-coding', title: 'Vibe Coding 技能' },
        { href: '/learn/tuyaopen-ide-agent-dev', title: 'Agent 开发指南' },
      ],
    },
    {
      id: 'sdk',
