export const tuyaOpenIdeCopy = {
  en: {
    ...
    download: {
      ...
      desc: 'The VS Code Marketplace listing is temporarily unavailable — install TuyaOpen IDE from the Open VSX registry, or download the .vsix and install it manually in VS Code or Cursor.',
    ...
    installDialog: {
      ...
      subtitle: 'Pick your editor below — VS Code and Cursor are both supported.',
      vscode: {
        label: 'VS Code users',
      ...
      cursor: {
        label: 'Cursor users',
        title: 'Search the extension marketplace',
        desc: 'Cursor installs from the Open VSX registry by default — just search and install in one click.',
        guideTitle: 'How to install',
        steps: [
          'Open Cursor and open the Extensions view — Ctrl+Shift+X (⌘+Shift+X on macOS).',
          'Search for “TuyaOpen IDE”.',
          'Click Install on the result published by TuyaOpen.',
        ],
      },
      close: 'Close',
    },
  ...
  zh: {
    ...
    download: {
      title: '立即开始构建',
      desc: 'VS Code 应用市场页面暂时不可用 —— 可从 Open VSX 安装 TuyaOpen IDE，或下载 .vsix 文件在 VS Code / Cursor 中手动安装。',
      marketplace: '安装扩展',
      github: 'GitHub Releases',
      platforms: 'Windows x64 · macOS (Apple Silicon & Intel) · Linux x64',
    },
    installDialog: {
      ...
      subtitle: '在下方选择你使用的编辑器 —— VS Code 与 Cursor 均支持。',
      vscode: {
        label: 'VS Code 用户',
        title: '下载并安装 .vsix',
      ...
      cursor: {
        label: 'Cursor 用户',
        title: '插件市场直接搜索',
        desc: 'Cursor 默认从 Open VSX 仓库安装扩展，搜索后一键安装即可。',
        guideTitle: '安装步骤',
        steps: [
          '打开 Cursor，进入扩展视图 —— Ctrl+Shift+X（macOS 为 ⌘+Shift+X）。',
          '搜索 “TuyaOpen IDE”。',
          '在 TuyaOpen 发布的结果上点击安装。',
        ],
      },
      close: '关闭',
    },
