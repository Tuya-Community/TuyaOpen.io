export const tuyaOpenIdeCopy = {
  en: {
    ...
    hero: {
      ...
      floatTags: [
        { text: 'Hardware context synced', tone: 'teal' },
        { text: 'Vibe Coding active', tone: 'orange' },
        { text: 'HIL debug on device', tone: 'violet' },
        { text: 'Cloud Agent linked', tone: 'blue' },
        { text: 'Panel App synced', tone: 'green' },
      ],
    },
    features: {
  ...
  zh: {
    ...
    hero: {
      ...
      earlyPreview: '抢先体验 Preview 版本',
      screenshotAlt: 'IDE 主界面',
      floatTags: [
        { text: '硬件上下文已同步', tone: 'teal' },
        { text: 'Vibe Coding 进行中', tone: 'orange' },
        { text: '真机在环调试', tone: 'violet' },
        { text: '云端 Agent 已联通', tone: 'blue' },
        { text: '面板 App 已同步', tone: 'green' },
      ],
    },
    features: {
      label: '无缝集成',
