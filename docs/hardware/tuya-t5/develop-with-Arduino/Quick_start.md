...
It is recommended to use the [T5AI-Board Devkit](https://tuyaopen.ai/docs/hardware/tuya-t5/t5-ai-board/overview-t5-ai-board) and the [T5AI-Core Devkit](https://tuyaopen.ai/docs/hardware/tuya-t5/t5-ai-core/overview-t5-ai-core) for development.
