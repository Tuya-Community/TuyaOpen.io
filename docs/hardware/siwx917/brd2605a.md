...
The BRD2605A dev kit is Silicon Labs' official SiWx917 Wi-Fi 6 & Bluetooth LE Dev Kit (SiWx917-DK2605A), with TuyaOpen board support. The on-board SEGGER J-Link debugger covers flashing and log output over a single USB Type-C cable with no extra wiring, which makes it the easier kit to bring up compared with the AI dev kit. The board has no display, and audio is captured through the on-board MEMS microphone.
