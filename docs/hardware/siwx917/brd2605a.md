...
The BRD2605A dev kit is Silicon Labs' official SiWx917 Wi-Fi 6 & Bluetooth LE Dev Kit (SiWx917-DK2605A), with TuyaOpen board support. The on-board SEGGER J-Link debugger covers flashing and debugging over a single USB Type-C cable.
...
Expansion signals are brought to a 26-pin 2.54 mm **dual-row header**, silkscreened **EXP1A (odd) / EXP1B (even)**.
