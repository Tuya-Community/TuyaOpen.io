...
Otto Ninja is a dual-mode open-source robot that switches on demand between **Walking Mode** and **Wheeled Racing Mode**, built on the **Otto DIY** ecosystem and running on Tuya's T5 OTTO development board. Print the parts, flash the firmware, and drive it from the Tuya Smart App — schematics, code, and STEP files are all open for secondary development.
