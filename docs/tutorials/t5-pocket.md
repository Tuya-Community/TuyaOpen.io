...
**[T5-Pocket](https://github.com/tuya/TuyaOpen/tree/master/apps/tuya_t5_pocket/tuya_t5_pocket_ai)** is an open-source AI+IoT handheld companion built on TuyaOpen firmware — it runs an AI virtual pet, multimodal voice chat, retro games, and a wide set of sensor and peripheral expansions off one 2.9-inch reflective display. The latest firmware ships the following core features:
