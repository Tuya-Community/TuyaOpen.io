...
A companion robot that watches your focus and physically nudges you to rest — a tomato timer with a robotic arm. A brain-computer interface tracks concentration in real time; when focus drops, the arm intervenes (delivering a drink, for example), or a preset timer fires first.
