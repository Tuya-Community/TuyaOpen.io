...
A spherical robot built to look exactly like a soccer ball, rolling itself to the opposing goal on its own. A dual-wheel balancing chassis drives the movement; MinMax video generation rides on top.

A Hackathon showcase of a creative robotics project on TuyaOpen — entertainment first, with autonomous goal navigation doing the real work.
