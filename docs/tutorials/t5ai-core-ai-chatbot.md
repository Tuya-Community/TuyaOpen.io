...
Build an AI chatbot on the **T5AI-Core** board with an ST7789 display — flash the firmware with `tos.py`, fill in your UUID and AuthKey, and the chat UI comes up on screen. For board details, see the [T5AI-Core Development Kit](https://tuyaopen.ai/zh/docs/hardware/t5-ai-core/overview-t5-ai-core); this guide covers the wiring, menuconfig, code changes, and flash flow.
