...
A pair of necklaces that flash the same light when someone with shared interests comes near — so you spend more time with people you actually click with. Bluetooth proximity detection does the sensing; a tag-matching algorithm decides the color.

The system pairs with a WeChat mini-program for profile and history, and exchanges contacts over NFC or QR. Built on TuyaOpen as a wearable that bridges online profiling with offline meeting.
