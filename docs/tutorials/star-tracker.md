...
A star-pointing compass built on the Tuya T5AI-CORE development board (T5-E1 chip module): a 4LineSPI TFT display rotates to point at celestial bodies using MPU6050 gyroscope heading, and a Tuya AI Agent fields astronomical dialogue through the cloud.

The hardware reinvents the compass — the TFT shows the rose, the MPU6050 supplies orientation, and orbital calculations drive the star pointer. The Tuya AI Agent, primed with astronomical expert prompts, handles the dialogue and real-time celestial-body identification through cloud processing.
