...
This guide walks you through building, flashing, and activating the DuckyClaw firmware on the [T5-AI Board](hardware-specific/tuya-t5/t5-ai-board/overview-t5-ai-board) development kit. It is for developers who want to run DuckyClaw on Tuya T5-AI hardware and connect the device to Tuya Cloud via the Smart Life app.
...
- **[T5-AI Board](hardware-specific/tuya-t5/t5-ai-board/overview-t5-ai-board)** development board (carries the T5 module).
...
- [T5-AI Board overview](hardware-specific/tuya-t5/t5-ai-board/overview-t5-ai-board)
- [Quick Start – Environment setup](quick-start/enviroment-setup)
- [Quick Start – Equipment authorization](quick-start/equipment-authorization)
