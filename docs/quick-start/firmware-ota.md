...
- A product created on the [Tuya IoT Platform](https://iot.tuya.com) with a PID.
...
3. Click **Add Custom Firmware**.
   ...
   - If you selected a Tuya module, click **Add Custom Firmware** in the row of the selected module solution.
   - If you are using a custom module, click **Add Custom Firmware** in the custom firmware row.
...
![Fill in firmware information to generate firmware key](https://images.tuyacn.com/fe-static/docs/img/df14b972-b7f6-45dc-a07e-f52a1023b309.png)
   ...
   - **Network type**: Select based on your module's connectivity.
...
3. Fill in the version number and release notes, then upload the compiled firmware files one by one. TuyaOpen produces three firmware types, identifiable by filename:
...
- [Authorize Devices](equipment-authorization)
