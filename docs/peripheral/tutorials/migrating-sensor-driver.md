...
description: "Migrating a sensor library to TuyaOpen: swap the Arduino or ESP-IDF bus layer for TKL APIs while keeping register and application logic intact."
keywords:
  - sensor driver
  - migration
  - arduino
