...
![External codec audio path: capture runs Microphone to Codec ADC over I2S to MCU; playback runs MCU over I2S to Codec DAC to PA to Speaker, with I2C control and a PA_GPIO enable line](/5b4c79b1-f967-4c14-b9f2-80aef6726652.png)
