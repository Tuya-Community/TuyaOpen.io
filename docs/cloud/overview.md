...
**Required for Tuya service access**:
   ...
   - step2: Obtain [Tuya Universal Serial Tool](https://www.tuyaopen.ai/zh/tyutool) for firmware burning, TuyaOpen authorization code writing, serial debugging, etc.
