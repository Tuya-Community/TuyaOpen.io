...
![A smart oven whose functions — set_temperature, set_time, top_heat, bottom_heat, start, stop, camera — are exposed as tool calls to an AI agent that plans a recipe](/img/cloud/device-ai/smart-oven-tools.png)
