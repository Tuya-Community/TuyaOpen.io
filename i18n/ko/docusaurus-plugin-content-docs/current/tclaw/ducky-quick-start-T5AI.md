---
title: TClaw 와 T5AI
description: "TClaw T5-AI 보드 빌드, 플래시 및 Tuya Cloud를 사용하여 Tuya T5-AI 하드웨어에서 Edge-AI 음성 펌웨어를 활성화합니다."
keywords:
  - duckyclaw
  - tclaw
  - t5ai
...
# TClaw 빠른 시작 (T5-AI 널)
이 가이드는 건물, 번쩍이고, TClaw (이전 DuckyClaw) 펌웨어를 활성화[T5-AI 게시판](/docs/hardware/tuya-t5/t5-ai-board/overview-t5-ai-board)개발 키트. Tuya T5-AI 하드웨어에서 TClaw를 실행하고 스마트 라이프 앱을 통해 Tuya Cloud에 장치를 연결합니다.


## 제품 정보
- **[T5-AI 게시판](/docs/hardware/tuya-t5/t5-ai-board/overview-t5-ai-board)** 발달 널 (T5 단위를 나르십시오).
...
:::note
T5-AI 보드는 내장 마이크 및 스피커 지원이 있습니다. mic/speaker, **ASR**(Automatic Speech Recognition)가 기본 입력 방식이며 IM(messaging apps)와 coexist가 가능합니다.
:::
...
** TUYA T5AI BOARD LCD 3.5 CAMERA**를 선택하십시오.
...
**확장된 결과:** 펌웨어는 오류없이 구축, T5-AI 보드에 플래시, 및 장치 부츠. 시리얼 모니터를 사용하여 앱에 장치를 추가하기 전에 시작 및 활성화 모드를 확인합니다.
...
## 이름 *
- [TClaw 개요](/tclaw)
- [T5-AI 이사회 개요](/docs/hardware/tuya-t5/t5-ai-board/overview-t5-ai-board)
