...
## 개요
**T5AI-Core** 보드에 AI chatbot을 빌드하십시오. ST7789 디스플레이 - `tos.py`를 사용하여 펌웨어를 플래시하고 UUID 및 AuthKey를 채우고 채팅 UI는 화면에 올립니다. 널 세부사항을 위해, [T5AI 핵심 발달 장비] (https://tuyaopen.ai/zh/docs/hardware/t5-ai-core/overview-t5-ai-core); 이 가이드는 배선, menuconfig의 부호 변화 및 저속한 교류를 포함합니다.
