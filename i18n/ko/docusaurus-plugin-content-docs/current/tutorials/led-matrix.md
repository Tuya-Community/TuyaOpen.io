...
## ♨ TuyaOpen 소개
이 프로젝트는 ** TuyaOpen**, 오픈 소스 AI+IoT 개발 프레임 워크와 내장되어 있습니다. Tuya의 스마트 연결 장치. 그것은 여러 칩 플랫폼에 걸쳐 멀티modal AI - 오디오, 비디오 및 센서 처리 - RTOS-like 시스템 서비스와 함께.
...
## 프로젝트 개요
16x16 (256-LED) WS2812B 매트릭스를 구축하여 8 개의 애니메이션 효과를 실행합니다. - 색상, 2D 파, 스크롤 텍스트, 리플 및 더 많은 - TuyaOpen SDK와 T5AI 코어 보드. 1개의 자료 철사는 전체적인 전시를 모읍니다; 이 part-1는 기계설비는 나중에 부분에서 커버된 구름과 IoT 통합과 더불어 및 생기 부호를, 가져옵니다.
