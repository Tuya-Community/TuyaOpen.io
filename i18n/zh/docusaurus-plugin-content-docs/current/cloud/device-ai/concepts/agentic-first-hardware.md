---
title: 面向智能体的硬件
description: "面向智能体的硬件以 AI 智能体作为主要交互界面，由用户说出意图、设备自行决定如何完成，颠覆 App 优先的菜单交互模式。"
keywords:
  - 面向智能体的硬件
  - 物理 AI Agent
  - 智能体硬件
...
![App 优先的设备让用户学习菜单才能触达固定的控件；面向智能体的设备把用户意图经由 AI 智能体路由到设备的能力](https://images.tuyacn.com/fe-static/docs/img/8ca40e51-b3b4-4aaa-92c8-d42d9d904e45.png)
