...
sidebar_label: "TuyaOpen IDE 是什么"
sidebar_position: 1
keywords:
  - TuyaOpen IDE
  - TuyaOpen
...
1. [**安装 TuyaOpen IDE**](./install.md)——在 VS Code 或 Cursor 中安装扩展。
2. [**实战一：Hello World**](./hello-world.md)——IDE 基础操作：选板 → 编译 → 烧录 → 看日志。
3. [**实战二：your_chat_bot**](./chat-bot.md)——云端 IoT / AI Agent 开发流程。
4. [**实战三：小程序面板**](./miniapp-panel.md)——为设备做一个手机控制面板。
5. [**Vibe Coding 技能**](./vibe-coding.md)——IDE 内置 AI 技能的可复制提示词。
6. [**Agent 开发指南**](./agent-development.md)——深入学习云端 Agent 的开发、发布与绑定。
