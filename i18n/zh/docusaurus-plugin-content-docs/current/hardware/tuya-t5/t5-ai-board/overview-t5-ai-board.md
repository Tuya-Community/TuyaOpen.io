...
![T5AI-Board 开发板正面图](https://images.tuyacn.com/fe-static/docs/img/83859360-38f6-42c2-9614-99b47f487775.jpg)
...
T5AI-Board 基于 T5-E1-IPEX 模组，该模组是涂鸦智能开发的嵌入式 Wi-Fi 和蓝牙组合模组。开发板配备 2 个麦克风和 1 个扬声器，支持语音识别与播放，实现语音交互功能。

通过开发板上的 I/O 连接器，您可以堆叠 LCD 显示模块以实现触摸屏与摄像头采集功能。您也可以自行设计 LCD 屏幕，支持 I2C、SPI、8080 和 RGB 等多种接口。
...
![T5AI-Board 引脚图](https://images.tuyacn.com/fe-static/docs/img/6b7ab959-0635-4293-991b-b8dda293614b.jpg)
...
T5AI-Board 支持可选的 LCD 屏幕和摄像头模块，可堆叠在主板上。
...
![堆叠的 LCD 与摄像头模块引脚分配](https://images.tuyacn.com/content-platform/hestia/173693668247bb1930ac5.png)
...
- [T5AI-Board Demo 聊天机器人](/docs/cloud/device-ai/demo-your-chat-bot)
- [T5AI-Board Demo IoT 智能插座/灯](/docs/cloud/iot-client/demo-tuya-iot-light)
