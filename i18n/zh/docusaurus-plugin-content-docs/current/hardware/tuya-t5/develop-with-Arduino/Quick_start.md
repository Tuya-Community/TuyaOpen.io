...
推荐使用 [T5AI-Board Devkit](https://tuyaopen.ai/zh/docs/hardware/tuya-t5/t5-ai-board/overview-t5-ai-board) 开发板和 [T5AI-Core Devkit](https://tuyaopen.ai/zh/docs/hardware/tuya-t5/t5-ai-core/overview-t5-ai-core) 开发板进行开发。
