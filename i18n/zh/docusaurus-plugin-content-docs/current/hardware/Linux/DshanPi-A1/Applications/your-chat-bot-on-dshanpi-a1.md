...
本文档将指导你在 [DshanPi-A1](https://rockchip.100ask.net/en/docs/DshanPi-A1/intro/) 开发板上运行 TuyaOpen 的 [your_chat_bot](https://tuyaopen.ai/zh/docs/cloud/device-ai/demo-your-chat-bot) 聊天机器人项目。
