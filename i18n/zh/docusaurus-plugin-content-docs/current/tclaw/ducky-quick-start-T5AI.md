---
title: TClaw 与 T5-AI
description: "T5-AI Board 开发板上构建、烧录并激活 TClaw 固件的快速开始指南，通过智能生活 App 连接 Tuya Cloud。"
keywords:
  - TClaw
  - T5-AI
  - T5AI
...
# TClaw 快速开始（T5-AI Board）

本文介绍如何在 [T5-AI Board](/docs/hardware/tuya-t5/t5-ai-board/overview-t5-ai-board) 开发板上构建、烧录并激活 TClaw（原名 DuckyClaw）固件，面向希望在 Tuya T5-AI 硬件上运行 TClaw 并通过智能生活 App 连接 Tuya Cloud 的开发者。
