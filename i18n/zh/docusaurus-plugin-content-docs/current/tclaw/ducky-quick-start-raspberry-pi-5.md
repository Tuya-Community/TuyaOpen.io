---
title: TClaw 与 Raspberry Pi 5
description: "Raspberry Pi 5 上构建并运行 TClaw 的快速开始指南，Linux 主机无需烧录固件，通过智能生活 App 接入 Tuya Cloud。"
keywords:
  - TClaw
  - Raspberry Pi 5
  - 树莓派 5
...
# TClaw 快速开始（Raspberry Pi 5）

本文介绍如何在 Raspberry Pi 5 上构建并运行 TClaw（原名 DuckyClaw）。树莓派属于 Linux 主机目标，无需烧录固件，构建产物为可执行文件。面向希望在 Raspberry Pi 5 上运行 TClaw 并通过智能生活 App 连接 Tuya Cloud 的开发者。
