...
| Stage                                | Date                          |
|-------------------------------------|-------------------------------|
| Registration Period                 | Nov 20 – Dec 20, 2025         |
| First Submission Deadline           | Dec 20, 2025                  |
| First-Round Evaluation              | Mid-Dec 2025                  |
| Improvement Period                  | Mid-Dec 2025 – Early Jan 2026 |
| Demo Day (CES, Las Vegas)           | Jan 4, 2026                   |
| Final Submission Deadline           | Feb 20, 2026                  |
| Winners Announcement                | Early Mar 2026                |


## 3. Event Overview
 **Competition Tracks**
 All entries must be developed based on the TuyaOpen Platform AI Open-Source Package.
 Participants can choose **one of three tracks** to build their AI hardware demo.

| Track Name               | Description                                                                 |
|--------------------------|-----------------------------------------------------------------------------|
| **AI Agent Application** | Focus on multimodal intelligent agents, voice/image recognition, AI assistants, and other innovative projects (no hardware experience required). |
| **Hardware Development** | Build creative hardware using Tuya development boards — including but not limited to desktop robots, AI chatbots, AI toys, AI wearables, and AI + smart home devices.        |
| **Industry Solutions**   | Focus on AI + IoT applications across various industries — including but not limited to energy management, healthcare, education, and industrial innovation scenarios.        |
...
|----------------|----------------------------------|
| GitHub Resource Site | [https://github.com/tuya/TuyaOpen](https://github.com/tuya/TuyaOpen) |
| Module Specification Documents | https://developer.tuya.com/en/docs/iot/T5-E1-Module-Datasheet?id=Kdar6hf0kzmfi |
| TuyaOpen & TuyaOS Documentation Collection | https://tuyaopen.ai/zh/blog | TuyaOpen](https://tuyaopen.ai/blog) |
| AI Agent Development | [https://developer.tuya.com/cn/docs/iot/ai-agent-management?id=Kdxr4v7uv4fud](https://developer.tuya.com/en/docs/iot/ai-agent-management?id=Kdxr4v7uv4fud) |

- **Video Resources**：Latest Developer Demos & Tutorials Collection
Follow Tuya’s official YouTube channel: https://www.youtube.com/@tuya2023/videos 
 (For more resources, see Appendix 1)
...
● **Hardware Requirements**:  
  1️⃣ **Development Board**: **T5 series is recommended**; other TuyaOpen-supported ecosystems are available. See [https://tuyaopen.ai/docs/about-tuyaopen](https://tuyaopen.ai/docs/about-tuyaopen) for details.  
...
1. **Complete Project Introduction PDF** (Required)  
   Example: [https://drive.google.com/file/d/1IOT_VpJG1q701favo4UujjE5cZ6Cyp7q/view](https://drive.google.com/file/d/1IOT_VpJG1q701favo4UujjE5cZ6Cyp7q/view)  
...
3. **GitHub Link**: Upload the part of code relevant to **TuyaOpen** to GitHub (if available): [https://github.com/tuya/TuyaOpen](https://github.com/tuya/TuyaOpen)  
...
● [https://tuyaopen.ai/get-hardware](https://tuyaopen.ai/get-hardware) （introduction）  
● [AliExpress](https://www.aliexpress.com/item/1005009476541406.html)
...
### Demo Videos
1. [TuyaOpen Framework Intro](https://www.youtube.com/watch?v=YQ7hDAvBsG4&t=229s)
2. [AI Smart Light Strip](https://www.youtube.com/watch?v=c_Of93erYdk)
3. [T5 AI Development Board](https://www.youtube.com/watch?v=kW9lWuF3RmE)
4. [AI Smart Power Socket](https://www.youtube.com/watch?v=7A8sYujTdno)
5. [AI Multi-Pet Recognition](https://www.youtube.com/watch?v=3JX4e09S70M)
6. [AI Smart Home](https://www.youtube.com/watch?v=5CJGn6necrQ)
...
2. Roadmap & Releases  
[Roadmap & Releases | TuyaOpen ](https://tuyaopen.ai/docs/maintenance-and-releases) 
...
### Q&A
1. FAQs  
[FAQs | TuyaOpen](https://tuyaopen.ai/docs/faqs)  
2. Contribution  
[Contribution Guide | TuyaOpen](https://tuyaopen.ai/docs/contribute/contribute-guide)  


### Projects
- [https://tuyaopen.ai/projects](https://tuyaopen.ai/projects)

 

## Appendix 2: Key Links

- **Project Intro PDF Example**:  
  [Google Drive](https://drive.google.com/file/d/1IOT_VpJG1q701favo4UujjE5cZ6Cyp7q/view?usp=drive_link)
